...
opts = {}
opts["root"] = '/data/p-one/mirosant/sim_10tev_cascade/tau/'
opts["out"] = '/data/p-one/mirosant/sim_10tev_cascade/tau/Genfiles'
opts["job"] = '/data/p-one/mirosant/sim_10tev_cascade/tau/jobfiles'
...
bash /data/p-one/mirosant/pone_offline/env-shell_Container.sh python {}/GenerateEvents.py -o {} -r $1
