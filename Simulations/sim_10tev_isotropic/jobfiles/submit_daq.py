...
opts = {}
opts["root"]    = '/data/p-one/mirosant/sim_10tev/'
opts["out"]     = '/data/p-one/mirosant/sim_10tev/DAQfiles'
opts["job"]     = '/data/p-one/mirosant/sim_10tev/jobfiles'
opts['in']      = '/data/p-one/mirosant/sim_10tev/Propfiles'
...
'''.format(opts["root"]+"Eventfiles",
           opts['in']+"/prop_",
           opts["out"]+"/daq_",
           "/data/p-one/mirosant/pone_offline/GCD/PONE_10spacing50.0String.i3.gz")
