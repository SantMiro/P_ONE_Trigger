...
parser.add_argument('-emin', '--energyMin', default = 4.0,                                            help="the minimum energy")
parser.add_argument('-emax', '--energyMax', default = 7.0,                                            help="the maximum energy")
parser.add_argument('-n',    '--numEvents', default = 12000,                                           help="number of events produced by the simulation")
